<?php
	...
	// $arquivo = $_FILES["file_fornecedor"];

    $phpmail->IsHTML(true);
	$phpmail->From = "envia@epi-tuiuti.com.br";
    $phpmail->FromName = $_POST["empresa-fornecedor"];
    $phpmail->AddReplyTo($_POST["email-fornecedor"], $_POST["empresa-fornecedor"]);
	...
	$target_path = $target_path . basename( $_FILES['file_fornecedor']['name']);
	move_uploaded_file($_FILES['file_fornecedor']['tmp_name'], $target_path);
   ...
   /// Destinatario
	...
	$phpmail->Subject = "Fornecedores - TUIUTI";
    $phpmail->Body .= "Empresa: ". $_POST["empresa-fornecedor"]."<br />";
    $phpmail->Body .= "Contato: ". $_POST["contato-fornecedor"]."<br />";
    $phpmail->Body .= "Endereço: ". $_POST["endereco-fornecedor"]."<br />";
    $phpmail->Body .= "Telefone: ". $_POST["tel-fornecedor"]."<br />";
    $phpmail->Body .= "E-mail: ". $_POST["email-fornecedor"]."<br />";
    $phpmail->Body .= "Qual o seu produto?: ". $_POST["produto-fornecedor"]."<br />";
	$phpmail->Body .= "Mensagem: ".nl2br($_POST["msg-fornecedor"])."<br />";
	...
	/* Template Name: Resposta Fornecedores */  
	get_header();
?>
...
<section class="content_wrapper">
	...
	<section class="content">
		...
		<h1 class="title full"><?php echo get_the_title(25) ?></h1>
